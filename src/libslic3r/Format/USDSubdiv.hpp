#ifndef slic3r_Format_USDSubdiv_hpp_
#define slic3r_Format_USDSubdiv_hpp_

// Evaluate a USD subdivision surface (Catmull-Clark, Loop or bilinear) to a refined n-gon control
// mesh -- creases, corners, interpolateBoundary, triangleSubdivisionRule -- validated against
// OpenSubdiv. Affine-covariant: refine the control mesh first, apply the world transform after.
...
namespace Slic3r { namespace usd_subdiv {
